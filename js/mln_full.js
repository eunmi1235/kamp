  ...
  (function($)
  {
    $.fn.mln_full = function(opcoes)
    {
      return this.each (function(i,v)
      {
        ...
        css += 'nav#menu_dir {position: fixed; right: 5%; top: 50%; height: 300px; margin-top: -100px; z-index: 99; }';
        css += 'nav#menu_dir ul {float: left; width: 200px; }';
        css += 'nav#menu_dir ul li {float: left; width: 100%; cursor: pointer; cursor: hand; color: '+opcoes.color+'; font-size: 14px; font-weight:700; padding: 5px 0px;}';
        css += 'nav#menu_dir li span { float: right; display: none; text-align: right; margin-right: 7px; margin-top: -4px; }';
        css += 'nav#menu_dir li div { float: right; height: 15px; width: 15px; background-color: '+opcoes.color+'; border-radius: 50%; -moz-border-radius: 50%; }';
